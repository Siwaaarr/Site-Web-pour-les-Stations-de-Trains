    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-nav a {
            ...
            font-size: 0.9rem; display: flex; align-items: center; gap: 7px;
        }
        ...
        .btn-site:hover { background: rgba(255,255,255,0.25); }

        .btn-logout {
            background: rgba(239,83,80,0.25); color: #ef9a9a;
            padding: 8px 16px; border-radius: 8px;
            text-decoration: none; font-size: 0.9rem;
            display: flex; align-items: center; gap: 7px;
        }
        ...
        .card { background: white; border-radius: 12px; padding: 25px; box-shadow: 0 2px 12px rgba(0,0,0,0.07); margin-bottom: 25px; }
        .card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 2px solid #e8f5e9; }
        ...
        .btn { display: inline-flex; align-items: center; gap: 7px; padding: 9px 18px; border-radius: 8px; font-weight: 600; font-size: 0.9rem; cursor: pointer; border: none; text-decoration: none; }
...
<header class="admin-header">
    ...
    <div class="header-right">
        <a href="../home.php" target="_blank" class="btn-site">
